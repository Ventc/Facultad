...
package arreglo_ejercicio_14;

import java.util.Scanner;

public class Arreglo_Ejercicio_14 {
    ...
    public static void main(String[] args) {
            ...
            System.out.println("Llamar el primer arreglo: ");
            do{
                    for(int i=0;i<10;i++){
            ...
            else{ //Significa que ya copiamos todo el arreglo b, falta el c
                    while(i<10){
                            c[k] = a[i];
                            i++;
                            k++;
