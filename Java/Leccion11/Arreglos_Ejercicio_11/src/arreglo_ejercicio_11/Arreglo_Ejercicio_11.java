...
ordenados de forma creciente. Estos los guardaremos en una tabla de tamaño 10.
Leer un numero "N" e insertarlo en el lugar adecuado para que la tabla continue ordenada.
*/


package arreglo_ejercicio_11;
...
public class Arreglo_Ejercicio_11 {
    ...
    public static void main(String[] args) {
            ...
            do{
                ...
                if(creciente == false){
                        System.out.println("\nEl arrelgo no esta ordenado en forma creciente, vuelve a digitar\n");
                }
