/*
Ejercicio 13: Leer 10 numeros en una tabla. Guardar en otra tabla los
elementos pares de la primera, y a continuacion los elementos impares
*/


package arreglo_ejercicio_13;

import java.util.Scanner;

public class Arreglo_Ejercicio_13 {
    ...
    public static void main(String[] args) {
            ...
            for(int i=0;i<10;i++){
                    ...
                    if(arreglo[i]%2==0){//Contamos para crear arreglos
                            conteo_pares++;
                    }
                    else{
                            conteo_impares++;
